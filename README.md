...
# Утановка
Перед началом работы с программой требуется скачать репозиторий. Для этого можно воспользоваться install.sh. В таком случае можно будет пропустить пункт "Необходимые библиотеки и их установка".
